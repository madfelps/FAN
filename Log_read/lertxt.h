...
#include <iostream> //lib padrão c++
#include <inttypes.h>
#include <stdio.h>  //lib padrão c/c++
#include <stdlib.h> // lib padrão c/c++
#include <string.h>	// lib do C para strings 
#include <string>	//lib para usar std::strings...
#include <unistd.h>
#include <net/if.h>
#include <sys/ioctl.h>
...
#include <ncurses.h>
#include <time.h>
#include <fstream>	//lib para leitura de arquivo
#include <omp.h>	//lib para implementação do OpenMP
#include "lertxt.h"
#include <vector>   //lib para criar vetores
#include "nlohmann/json.hpp" //lib para impl
