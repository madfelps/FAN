    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->textTempMotor->setStyleSheet("QTextEdit{ " "background-color:rgb(211, 215, 207);""border: 3px solid gray;""border-radius: 10px;""padding: 0 8px;""selection-background-color: darkgray;""font-size: 40px;}""QTextEdit:focus { ""background-color:rgb(192, 192, 255);}");
    ...
    ui->textTempInverter->setStyleSheet("QTextEdit{ " "background-color:rgb(211, 215, 207);""border: 3px solid gray;""border-radius: 10px;""padding: 0 8px;""selection-background-color: darkgray;""font-size: 40px;}""QTextEdit:focus { ""background-color:rgb(192, 192, 255);}");
    ...
    ui->setSpeedSlider->setSingleStep(100);
    /*Discretiza o slider*/
    ...
    /*Passa para a label de velocidade*/
